...
namespace margelo::nitro::splash {
  ...
  /**
   * A struct which can be represented as a JavaScript object (SplashLogoSpec).
   */
  struct SplashLogoSpec final {
  public:
  ...
  public:
    SplashLogoSpec() = default;
    explicit SplashLogoSpec(std::string name, double width, double height): name(name), width(width), height(height) {}

  public:
    friend bool operator==(const SplashLogoSpec& lhs, const SplashLogoSpec& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ SplashLogoSpec <> JS SplashLogoSpec (object)
  template <>
  struct JSIConverter<margelo::nitro::splash::SplashLogoSpec> final {
    static inline margelo::nitro::splash::SplashLogoSpec fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::splash::SplashLogoSpec(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::splash::SplashLogoSpec& arg) {
